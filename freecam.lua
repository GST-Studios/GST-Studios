...
local FREECAM_MACRO_KB = {Enum.KeyCode.X}
...
local Input = {} do
	...
	local NAV_KEYBOARD_SPEED = Vector3.new(0.1, 0.1, 0.1)
...
local function StepFreecam(dt)
	...
	cameraRot = cameraRot + pan*PAN_GAIN
	...
	cameraPos = cameraPos + cameraCFrame:VectorToWorldSpace(vel) * NAV_GAIN * dt
